...
void SinhVien::XuatSinhVien(int NumericalOrder) {
	...
	if (NumericalOrder < 10) {
		std::cout << NumericalOrder << setw(21) << this->MSSV << setw(20) << to_upper(this->LastName) << setw(20) << to_upper(this->FirstName) << setw(20) << this->birthDay.toStringDate() << setw(20)
		...
		std::cout << NumericalOrder << setw(20) << this->MSSV << setw(20) << to_upper(this->LastName) << setw(20) << to_upper(this->FirstName) << setw(20) << this->birthDay.toStringDate() << setw(20)
			<< GioiTinh << setw(20) << this->classRoom.toStringClassRoom() << setw(20) 
			<< setprecision(2) << fixed << this->MathPoint << setw(20)
			<< setprecision(2) << fixed << this->PhysicalPoint << setw(20)
			<< setprecision(2) << fixed << this->ITPoint << setw(20)
